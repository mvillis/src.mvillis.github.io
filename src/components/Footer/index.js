    ...
    <Container className="footer">
        <Row>
          <Col sm={8} xs={12} className="buffer-left">
            <p>© Mike Villis 2017 | All Rights Reserved</p>
          </Col>
          <Col sm={4} xs={12} className="buffer-right">
            ...
            <a href='https://www.github.com/mvillis' role='button' title='Facebook'>
              <svg width='36' height='36' viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
