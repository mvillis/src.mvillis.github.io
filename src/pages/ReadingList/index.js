...
import { Card, CardText, CardBlock, CardDeck, CardHeader,
  CardTitle, Container, Jumbotron, Row } from 'reactstrap';
import './styles.css';

const ReadingList = (props) => {
  return (
    <div>
      <Jumbotron fluid className="jumbo-over-reading">
        <Container fluid>
          <Container>
            <h1 className="header-top">Reading List</h1>
          </Container>
        </Container>
      </Jumbotron>
      <Container>
        <h5 className="h5-margin">There are roughly 40 articles there covering DevOps, Leadership, Career, Architecture as well as some generally fascinating reads I’ve collected over the last 4 years.</h5>
        <Row>
            <CardDeck>
